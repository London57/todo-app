...
func (m *MockInterface) Debug(message string, args ...any) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) Error(message string, args ...any) {
	m.ctrl.T.Helper()
	varargs := []interface{}{message}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (m *MockInterface) Info(message string, args ...any) {
	m.ctrl.T.Helper()
	varargs := []interface{}{message}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (m *MockInterface) Warn(message string, args ...any) {
	m.ctrl.T.Helper()
	varargs := []interface{}{message}
	for _, a := range args {
		varargs = append(varargs, a)
